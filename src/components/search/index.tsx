  ...
  return (
    <form onSubmit={handleSearch} className="relative group w-full md:w-60">
      ...
      <input
        ...
        className="h-10 w-full md:w-60 bg-transparent border border-gray-400 pl-9
                    text-gray-100 rounded-md text-body-sm outline-none transition-all duration-200 focus-within:border-blue-300 
